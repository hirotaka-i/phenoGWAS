...
library(parallel)
# Read data
ltg_all=fread('../PhenoFile.csv') %>% data.frame
names(ltg_all)
...
temp1 = ltg_all %>% filter(COHORT == "PDBP") %>% distinct(ID, PID)
...
ltg_all = ltg_all %>% mutate(PC1 = rnorm(nrow(ltg_all), 0, 1), 
                             ...
                             X1 = rnorm(nrow(ltg_all), 0, 1),
                             X2 = rnorm(nrow(ltg_all), 0, 1),
                             X3 = rnorm(nrow(ltg_all), 0, 1),
                             X4 = rnorm(nrow(ltg_all), 0, 1),
                             X5 = rnorm(nrow(ltg_all), 0, 1),
                             X6 = rnorm(nrow(ltg_all), 0, 1),
                             X7 = rnorm(nrow(ltg_all), 0, 1),
                             X8 = rnorm(nrow(ltg_all), 0, 1),
                             X9 = rnorm(nrow(ltg_all), 0, 1),
                             X10 = rnorm(nrow(ltg_all), 0, 1),
                             X11 = rnorm(nrow(ltg_all), 0, 1),
                             X12 = rnorm(nrow(ltg_all), 0, 1),
                             X13 = rnorm(nrow(ltg_all), 0, 1),
                             X14 = rnorm(nrow(ltg_all), 0, 1),
                             X15 = rnorm(nrow(ltg_all), 0, 1),
                             X16 = rnorm(nrow(ltg_all), 0, 1),
                             X17 = rnorm(nrow(ltg_all), 0, 1),
                             X18 = rnorm(nrow(ltg_all), 0, 1),
                             X19 = rnorm(nrow(ltg_all), 0, 1),
                             X20 = rnorm(nrow(ltg_all), 0, 1),
                             X21 = rnorm(nrow(ltg_all), 0, 1),
                             X22 = rnorm(nrow(ltg_all), 0, 1),
                             X23 = rnorm(nrow(ltg_all), 0, 1),
                             X24 = rnorm(nrow(ltg_all), 0, 1),
                             X25 = rnorm(nrow(ltg_all), 0, 1),)
